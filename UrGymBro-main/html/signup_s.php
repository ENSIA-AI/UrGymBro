...
$_SESSION['user']=$token;
unset($_SESSION['msg']);
header( "refresh:0;url=/UrGymBro-main/html/hompage_connected_s.php" );
exit();
...
<body>
  <nav>
    ...
    <ul class="nav-list" id="navbarList">
      <li class="nav-item"><a id="home" href="../html/homepage_s.php">HOME</a></li>
      <li class="nav-item"><a id="maps" href="../html/maps.php">MAPS
        </a></li>
      <li class="nav-item"><a id="products" href="../html/product_s.php">PRODUCTS</a></li>
      ...
      <li class="nav-item"><a id="login" href="../html/Login_Page_webdev_s.php">LOG IN </a></li>
    </ul>
  </nav>
    ...
    <div class="container">
      <form action="#" method="post" id="sign_up_form">
        ...
        <div class="reminder" id="have_acc">
          <p>You already have an account ?<a class="a_reminder" href="../html/Login_Page_webdev_s.php"> Login
              Now !</a></p>
        </div>
