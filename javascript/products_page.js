var my_products = [
  ...
  },
  {
    ...
    product_price: "14000",
    product_description:
      "Made of solid cast iron and coated in protective vinyl, the kettlebell is a convenient and powerful workout tool. Available in a spectrum of colors and weights, you can choose the training path that is right for you. Available in weights of 10, 12, 15, 18, 20, 25, 30, 35, 40, 45, 50, 55, and 60 pounds.",
  ...
  },
  {
    ...
    product_description:
      "Creatine Monohydrate is the monohydrate form of creatine similar or identical to endogenous creatine produced in the liver, kidneys, and pancreas. Creatine, in phosphate form, helps supply energy to muscle cells for contraction.",
  ...
  },
  {
    ...
    product_price: "82000",
    product_description:
      "This unique blend helps bodybuilders, athletes or any sportsperson a better recovery of muscles. Hydrolysate Whey gives an immediate spike of amino acids in blood for immediate recovery after the workout or when your body requires amino acids immediately and Whey Protein Isolate, sourced from USA.",
  ...
  },
  {
    ...
    product_price: "12200",
    product_description:
      "Helps support ATP recycling for explosive movements. Supports muscle building, recovery, performance, strength and power when used daily, over time and combined with exercise.",
  ...
  },
  {
    ...
    product_price: "120000",
    product_description:
      "The wall-mounted pull-up bar can be used both inside and outside to exercise the back, shoulders, chest, arms, triceps, biceps, strain, and front of the abdomen. Your hands are more comfortable on soft cushions, extending the duration of your workout.",
...
k=1;
    while (i < 9 * page) {
      ...
      console.log(my_products[i].product_name);
