...
if (isset($_SESSION['user'])) {
  header("refresh:1;url=/UrGymBro-main/html/products_connected_s.php");
  exit();
} ?>
<!DOCTYPE html>
<html>
...
<body>
  ...
  <nav>
    ...
    <ul class="nav-list" id="navbarList">
      <li class="nav-item">
        <a id="home" href="../html/homepage_s.php">HOME</a>
      </li>
      <li class="nav-item">
        <a id="maps" href="../html/maps.php">MAPS </a>
      </li>
      <li class="nav-item"><a id="products" href="#">PRODUCTS</a></li>
      <li class="nav-item"><a id="food" href="../html/Food.php">FOOD</a></li>
      <li class="nav-item">
        <a id="aboutus" href="../html/About_Us_webdev.php">ABOUT US </a>
      </li>
      <li class="nav-item">
        <a id="login" href="../html/Login_Page_webdev_s.php">LOG IN </a>
      </li>
    </ul>
  </nav>
  ...
  <div class="popup" id="popup1">
    <div class="popup-content">
      <form method="post" action="saveprod_s.php">
        <img src="../images/dumbell.jpg" id="product1_img" class="product_img" />
        ...
        <div class="text">
          ...
          <div class="link">
            <a class="links" href="https://www.hammer-fitness.at/at-en/hammer-kurzhantel-set-40kg-eisen.html">Iheb
              Boutique</a>
          </div>
