...
<body>
  ...
  <div class="reminder" id="forgot_password">
    <p>Forgot Password ?<a class="a_reminder" href="#"> Recover it Now !</a></p>
  </div>
  <div class="reminder" id="have_acc">
    <p>Don't have an account ?<a class="a_reminder" href="../html/signup_s.php"> Sign Up !</a></p>
  </div>
