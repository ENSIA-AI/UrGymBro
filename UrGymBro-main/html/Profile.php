...
<body>
    ...
    <div id="sidebar">
        ...
        <div class="sidebar_elements">
            <a href="Profile.php" id="sd">PROFILE</a>
            <a href="homepage.php" id="sd">HOME</a>
            <a href="maps.php" id="sd"> GYM LOCATIONS</a>
            <a href="products.php" id="sd">PRODUCTS</a>
            <a href="food.php" id="sd">FOOD</a>
            <a href="savings.php" id="sd">FOOD SAVINGS</a>
            <a href="product_savings.php" id="sd">PRODUCT SAVINGS</a>
            <a href="settings.php" id="sd">SETTINGS</a>
            <a href="About_Us_webdev.php" id="sd">ABOUT US</a>
            <a href="help.php" id="sd">HELP?</a>
            <a href="homepage.php"><img src="Logo red and gray.svg" alt="UR" width="120" height="80"> </a>
        </div>
    </div>
            ...
            <div class="profile_all">
                ...
                <div class="profile_txt" id="profile_txt">
                    ...
                    <div class="profile_inputs">
                        ...
                        echo '<input type="text" id="BMI" class="edit-mode" value=' . $BMI . ' disabled>'; ?>
                    </div>
