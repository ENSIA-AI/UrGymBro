...
if (!isset($_SESSION['user'])) {
    ...
    if (
        ...
        if ($verif->num_rows == 0) {
            ...
            header("refresh:1;url=/UrGymBro-main/html/product_savings_s.php");
        } else {
            ...
            $query = "DELETE FROM `product_savings` WHERE `Product_id`=?";
            $verif = $my_connection->prepare($query);
            $verif->bind_param('i', $prod_id);
            try {
                $result = $verif->execute();
            } catch (Exception $e) {
                $_SESSION['alert'] = "product Already removed or does not exist";
                header("refresh:0;url=/UrGymBro-main/html/product_savings_s.php");
                exit();
            }
...
<body>
  ...
  HTML AND LATER FROM THE DATABASE (BACKEND) -->
    ...
    <nav>
        <label class="logo"><a href="../html/homepage_s.php"><img src="../images/Property Black.svg"
                    width="100px" /></a></label>
    ...
    <div class="top_div">
        ...
        <div class="subtitle" id="kk">
            Your custom collection of items to enhance your workout !
        </div>
    ...
    <div class="products">
        ...
        <div class="product" id="product1">
            ...
            <div class="text">
                ...
                <input type="button" class="popup-button" id="popup-button1" data-product-number="1"
                    value="Show More..." />
            </div>
        </div>
        ...
        <div class="product" id="product2">
            ...
            <div class="text">
                ...
                <input type="button" class="popup-button" id="popup-button2" data-product-number="2"
                    value="Show More..." />
            </div>
        </div>
        ...
        <div class="product" id="product3">
            ...
            <div class="text">
                ...
                <input type="button" class="popup-button" id="popup-button3" data-product-number="3"
                    value="Show More..." />
            </div>
        </div>
        ...
        <div class="product" id="product4">
            ...
            <div class="text">
                ...
                <input type="button" class="popup-button" id="popup-button4" data-product-number="4"
                    value="Show More..." />
            </div>
        </div>
        ...
        <div class="product" id="product5">
            ...
            <div class="text">
                ...
                <input type="button" class="popup-button" id="popup-button5" data-product-number="5"
                    value="Show More..." />
            </div>
        </div>
        ...
        <div class="product" id="product6">
            ...
            <div class="text">
                ...
                <input type="button" class="popup-button" id="popup-button6" data-product-number="6"
                    value="Show More..." />
            </div>
        </div>
        ...
        <div class="product" id="product7">
            ...
            <div class="text">
                ...
                <input type="button" class="popup-button" id="popup-button7" data-product-number="7"
                    value="Show More..." />
            </div>
        </div>
        ...
        <div class="product" id="product8">
            ...
            <div class="text">
                ...
                <input type="button" class="popup-button" id="popup-button8" data-product-number="   8"
                    value="Show More..." />
            </div>
        </div>
        ...
        <div class="product" id="product9">
            ...
            <div class="text">
                ...
                <input type="button" class="popup-button" id="popup-button9" data-product-number="9"
                    value="Show More..." />
            </div>
        </div>
    </div>
        ...
        <div class="popup-content">
            ...
            <form method="post" action="#">
                ...
                <div class="text">
                    ...
                    <div class="link">
                        <a class="links"
                            href="https://www.hammer-fitness.at/at-en/hammer-kurzhantel-set-40kg-eisen.php">Iheb
                            Boutique</a>
                    </div>
...
$query2 = "SELECT User_id  FROM `users` WHERE `token`=?";
$verif = $my_connection->prepare($query2);
$verif->bind_param('s', $_SESSION["user"]);
$verif->execute();
$verif->store_result();
if ($verif->num_rows == 0) {
...
$query = "SELECT * FROM `products` INNER JOIN (SELECT `Product_id` AS `PI` FROM `product_savings` WHERE `User_id`=?)DT ON `products`.`Product_id`=`PI`";
$statement = $my_connection->prepare($query);
$statement->bind_param("s", $username);
$statement->execute();
$statement->store_result();
echo "<script>console.log(" . $statement->num_rows . ")</script>";

if ($statement->num_rows == 0) {

} else {
    $statement->bind_result($id, $product_name1, $product_price1, $product_type1, $product_description1, $product_img1, $product_link1, $pi);
