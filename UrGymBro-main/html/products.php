...
<body>
  ...
  <nav>
    ...
    <ul class="nav-list" id="navbarList">
      <li class="nav-item">
        <a id="home" href="../html/homepage.html">HOME</a>
      </li>
      <li class="nav-item">
        <a id="maps" href="../html/maps.html">MAPS </a>
      </li>
      <li class="nav-item"><a id="products" href="#">PRODUCTS</a></li>
      <li class="nav-item"><a id="food" href="../html/Food.html">FOOD</a></li>
      <li class="nav-item">
        <a id="aboutus" href="../html/About_Us_webdev.html">ABOUT US </a>
      </li>
      <li class="nav-item">
        <a id="login" href="../html/Login_Page_webdev.html">LOG IN </a>
      </li>
    </ul>
  </nav>
  ...
  <div class="popup" id="popup1">
    ...
    <form method="post" action="saveprod.php">  
    <img src="../images/dumbell.jpg" id="product1_img" class="product_img" />
      ...
      <div class="text">
        ...
        <div class="button-container">
          <input type="submit" class="popup-button" id="popup1-button1" data-product-number="1" value="Add to Savings" /></form>
        </div>
      </div>
    </div>
  </div>
